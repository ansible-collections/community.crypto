...
class SelfSignedCertificateBackendCryptography(CertificateBackend):
    def __init__(self, module):
        ...
        self.notBefore = get_relative_time_option(module.params['selfsigned_not_before'], 'selfsigned_not_before', backend=self.backend, with_timezone=CRYPTOGRAPHY_TIMEZONE)
        self.notAfter = get_relative_time_option(module.params['selfsigned_not_after'], 'selfsigned_not_after', backend=self.backend, with_timezone=CRYPTOGRAPHY_TIMEZONE)
