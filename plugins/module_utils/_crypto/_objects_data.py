...
OID_MAP: dict[str, tuple[str, ...] | list[tuple[str, ...]]] = {
    ...
    "0.4.0": ("etsi",),
    "0.4.0.1733": ("electronic-signature-standard",),
    "0.4.0.1733.2": ("ess-attributes",),
    "0.4.0.1733.2.1": ("id-aa-ets-mimeType",),
    "0.4.0.1733.2.2": ("id-aa-ets-longTermValidation",),
    "0.4.0.1733.2.3": ("id-aa-ets-SignaturePolicyDocument",),
    "0.4.0.1733.2.4": ("id-aa-ets-archiveTimestampV3",),
    "0.4.0.1733.2.5": ("id-aa-ATSHashIndex",),
    "0.4.0.19122": ("cades",),
    "0.4.0.19122.1": ("cades-attributes",),
    "0.4.0.19122.1.1": ("id-aa-ets-signerAttrV2",),
    "0.4.0.19122.1.3": ("id-aa-ets-sigPolicyStore",),
    "0.4.0.19122.1.4": ("id-aa-ATSHashIndex-v2",),
    "0.4.0.19122.1.5": ("id-aa-ATSHashIndex-v3",),
    ...
    "1.2.156.10197.1.104.8": ("sm4-gcm", "SM4-GCM"),
    "1.2.156.10197.1.104.9": ("sm4-ccm", "SM4-CCM"),
    "1.2.156.10197.1.104.10": ("sm4-xts", "SM4-XTS"),
    ...
    "1.2.643.100.5": ("OGRNIP", "OGRNIP"),
    "1.2.643.100.111": ("Signing Tool of Subject", "subjectSignTool"),
    "1.2.643.100.112": ("Signing Tool of Issuer", "issuerSignTool"),
    "1.2.643.100.113": ("Class of Signing Tool", "classSignTool"),
    "1.2.643.100.113.1": ("Class of Signing Tool KC1", "classSignToolKC1"),
    "1.2.643.100.113.2": ("Class of Signing Tool KC2", "classSignToolKC2"),
    "1.2.643.100.113.3": ("Class of Signing Tool KC3", "classSignToolKC3"),
    "1.2.643.100.113.4": ("Class of Signing Tool KB1", "classSignToolKB1"),
    "1.2.643.100.113.5": ("Class of Signing Tool KB2", "classSignToolKB2"),
    "1.2.643.100.113.6": ("Class of Signing Tool KA1", "classSignToolKA1"),
    "1.2.804": ("ISO-UA",),
    ...
    "1.2.840.113549.1.9.16.1.47": ("id-ct-geofeedCSVwithCRLF",),
    "1.2.840.113549.1.9.16.1.48": ("id-ct-signedChecklist",),
    "1.2.840.113549.1.9.16.1.49": ("id-ct-ASPA",),
    "1.2.840.113549.1.9.16.1.50": ("id-ct-signedTAL",),
    "1.2.840.113549.1.9.16.1.51": ("id-ct-rpkiSignedPrefixList",),
    ...
    "1.2.840.113549.1.9.16.2.44": ("id-aa-ets-attrCertificateRefs",),
    "1.2.840.113549.1.9.16.2.45": ("id-aa-ets-attrRevocationRefs",),
    ...
    "1.2.840.113549.1.9.16.3.28": ("HKDF-SHA256", "id-alg-hkdf-with-sha256"),
    "1.2.840.113549.1.9.16.3.29": ("HKDF-SHA384", "id-alg-hkdf-with-sha384"),
    "1.2.840.113549.1.9.16.3.30": ("HKDF-SHA512", "id-alg-hkdf-with-sha512"),
    ...
    "1.2.840.113549.1.9.16.13": ("id-smime-ori",),
    "1.2.840.113549.1.9.16.13.3": ("id-smime-ori-kem",),
    ...
    "1.3.6.1.4.1.311.25.2": ("Microsoft NTDS CA Extension", "ms-ntds-sec-ext"),
    "1.3.6.1.4.1.311.25.2.1": ("Microsoft NTDS AD objectSid", "ms-ntds-obj-sid"),
    ...
    "1.3.6.1.5.5.7.0.50": ("id-mod-cmp2000-02",),
    "1.3.6.1.5.5.7.0.99": ("id-mod-cmp2021-88",),
    "1.3.6.1.5.5.7.0.100": ("id-mod-cmp2021-02",),
    ...
    "1.3.6.1.5.5.7.1.28": ("sbgp-ipAddrBlockv2",),
    "1.3.6.1.5.5.7.1.29": ("sbgp-autonomousSysNumv2",),
    ...
    "1.3.6.1.5.5.7.3.29": ("CMC Archive Server", "cmcArchive"),
    "1.3.6.1.5.5.7.3.30": ("BGPsec Router", "id-kp-bgpsec-router"),
    "1.3.6.1.5.5.7.3.31": (
        "Brand Indicator for Message Identification",
        "id-kp-BrandIndicatorforMessageIdentification",
    ),
    "1.3.6.1.5.5.7.3.32": ("Certificate Management Key Generation Authority", "cmKGA"),
    ...
    "1.3.6.1.5.5.7.4.17": ("id-it-caCerts",),
    "1.3.6.1.5.5.7.4.18": ("id-it-rootCaKeyUpdate",),
    "1.3.6.1.5.5.7.4.19": ("id-it-certReqTemplate",),
    "1.3.6.1.5.5.7.4.20": ("id-it-rootCaCert",),
    "1.3.6.1.5.5.7.4.21": ("id-it-certProfile",),
    "1.3.6.1.5.5.7.4.22": ("id-it-crlStatusList",),
    "1.3.6.1.5.5.7.4.23": ("id-it-crls",),
    ...
    "1.3.6.1.5.5.7.5.1.7": ("id-regCtrl-altCertTemplate",),
    "1.3.6.1.5.5.7.5.1.11": ("id-regCtrl-algId",),
    "1.3.6.1.5.5.7.5.1.12": ("id-regCtrl-rsaKeyLen",),
    ...
    "1.3.6.1.5.5.7.8.4": ("Hardware Module Name", "id-on-hardwareModuleName"),
    "1.3.6.1.5.5.7.8.5": ("XmppAddr", "id-on-xmppAddr"),
    "1.3.6.1.5.5.7.8.7": ("SRVName", "id-on-dnsSRV"),
    "1.3.6.1.5.5.7.8.8": ("NAIRealm", "id-on-NAIRealm"),
    "1.3.6.1.5.5.7.8.9": ("Smtp UTF8 Mailbox", "id-on-SmtpUTF8Mailbox"),
    ...
    "1.3.6.1.5.5.7.14": ("id-cp",),
    "1.3.6.1.5.5.7.14.2": ("ipAddr-asNumber",),
    "1.3.6.1.5.5.7.14.3": ("ipAddr-asNumberv2",),
    ...
    "1.3.6.1.5.5.7.48.10": ("RPKI Manifest", "rpkiManifest"),
    "1.3.6.1.5.5.7.48.11": ("Signed Object", "signedObject"),
    "1.3.6.1.5.5.7.48.13": ("RPKI Notify", "rpkiNotify"),
    ...
    "2.5.29.42": ("X509v3 Delegated Name Constraints", "delegatedNameConstraints"),
    "2.5.29.43": ("X509v3 Time Specification", "timeSpecification"),
    "2.5.29.46": ("X509v3 Freshest CRL", "freshestCRL"),
    "2.5.29.48": ("X509v3 Attribute Descriptor", "attributeDescriptor"),
    "2.5.29.49": ("X509v3 User Notice", "userNotice"),
    "2.5.29.50": ("X509v3 Source of Authority Identifier", "sOAIdentifier"),
    "2.5.29.52": ("X509v3 Acceptable Certification Policies", "acceptableCertPolicies"),
    ...
    "2.5.29.57": ("X509v3 Acceptable Privilege Policies", "acceptablePrivPolicies"),
    "2.5.29.61": ("X509v3 Indirect Issuer", "indirectIssuer"),
    "2.5.29.62": ("X509v3 No Assertion", "noAssertion"),
    "2.5.29.63": (
        "X509v3 Attribute Authority Issuing Distribution Point",
        "aAissuingDistributionPoint",
    ),
    "2.5.29.64": ("X509v3 Issued On Behalf Of", "issuedOnBehalfOf"),
    "2.5.29.65": ("X509v3 Single Use", "singleUse"),
    "2.5.29.66": ("X509v3 Group Attribute Certificate", "groupAC"),
    "2.5.29.67": (
        "X509v3 Allowed Attribute Assignments",
        "allowedAttributeAssignments",
    ),
    "2.5.29.68": ("X509v3 Attribute Mappings", "attributeMappings"),
    "2.5.29.69": ("X509v3 Holder Name Constraints", "holderNameConstraints"),
    "2.5.29.70": ("X509v3 Authorization Validation", "authorizationValidation"),
    "2.5.29.71": ("X509v3 Protocol Restriction", "protRestrict"),
    "2.5.29.72": (
        "X509v3 Subject Alternative Public Key Info",
        "subjectAltPublicKeyInfo",
    ),
    "2.5.29.73": ("X509v3 Alternative Signature Algorithm", "altSignatureAlgorithm"),
    "2.5.29.74": ("X509v3 Alternative Signature Value", "altSignatureValue"),
    "2.5.29.75": ("X509v3 Associated Information", "associatedInformation"),
    ...
    "2.16.840.1.101.3.4.2.19": ("kmac128", "KMAC128"),
    "2.16.840.1.101.3.4.2.20": ("kmac256", "KMAC256"),
    ...
    "2.16.840.1.101.3.4.3.17": ("ML-DSA-44", "id-ml-dsa-44"),
    "2.16.840.1.101.3.4.3.18": ("ML-DSA-65", "id-ml-dsa-65"),
    "2.16.840.1.101.3.4.3.19": ("ML-DSA-87", "id-ml-dsa-87"),
    "2.16.840.1.101.3.4.3.20": ("SLH-DSA-SHA2-128s", "id-slh-dsa-sha2-128s"),
    "2.16.840.1.101.3.4.3.21": ("SLH-DSA-SHA2-128f", "id-slh-dsa-sha2-128f"),
    "2.16.840.1.101.3.4.3.22": ("SLH-DSA-SHA2-192s", "id-slh-dsa-sha2-192s"),
    "2.16.840.1.101.3.4.3.23": ("SLH-DSA-SHA2-192f", "id-slh-dsa-sha2-192f"),
    "2.16.840.1.101.3.4.3.24": ("SLH-DSA-SHA2-256s", "id-slh-dsa-sha2-256s"),
    "2.16.840.1.101.3.4.3.25": ("SLH-DSA-SHA2-256f", "id-slh-dsa-sha2-256f"),
    "2.16.840.1.101.3.4.3.26": ("SLH-DSA-SHAKE-128s", "id-slh-dsa-shake-128s"),
    "2.16.840.1.101.3.4.3.27": ("SLH-DSA-SHAKE-128f", "id-slh-dsa-shake-128f"),
    "2.16.840.1.101.3.4.3.28": ("SLH-DSA-SHAKE-192s", "id-slh-dsa-shake-192s"),
    "2.16.840.1.101.3.4.3.29": ("SLH-DSA-SHAKE-192f", "id-slh-dsa-shake-192f"),
    "2.16.840.1.101.3.4.3.30": ("SLH-DSA-SHAKE-256s", "id-slh-dsa-shake-256s"),
    "2.16.840.1.101.3.4.3.31": ("SLH-DSA-SHAKE-256f", "id-slh-dsa-shake-256f"),
    ...
    "2.16.840.1.101.3.4.4": ("nistKems",),
    "2.16.840.1.101.3.4.4.1": ("ML-KEM-512", "id-alg-ml-kem-512"),
    "2.16.840.1.101.3.4.4.2": ("ML-KEM-768", "id-alg-ml-kem-768"),
    "2.16.840.1.101.3.4.4.3": ("ML-KEM-1024", "id-alg-ml-kem-1024"),
    ...
    "2.16.840.1.113894": ("Oracle organization", "oracle-organization"),
    "2.16.840.1.113894.746875.1.1": (
        "Trusted key usage (Oracle)",
        "oracle-jdk-trustedkeyusage",
    ),
    ...
    "2.23.133": ("Trusted Computing Group", "tcg"),
    "2.23.133.1": ("tcg-tcpaSpecVersion",),
    "2.23.133.2": ("Trusted Computing Group Attributes", "tcg-attribute"),
    "2.23.133.2.1": ("TPM Manufacturer", "tcg-at-tpmManufacturer"),
    "2.23.133.2.2": ("TPM Model", "tcg-at-tpmModel"),
    "2.23.133.2.3": ("TPM Version", "tcg-at-tpmVersion"),
    "2.23.133.2.10": ("Security Qualities", "tcg-at-securityQualities"),
    "2.23.133.2.11": ("TPM Protection Profile", "tcg-at-tpmProtectionProfile"),
    "2.23.133.2.12": ("TPM Security Target", "tcg-at-tpmSecurityTarget"),
    "2.23.133.2.13": ("TBB Protection Profile", "tcg-at-tbbProtectionProfile"),
    "2.23.133.2.14": ("TBB Security Target", "tcg-at-tbbSecurityTarget"),
    "2.23.133.2.15": ("TPM ID Label", "tcg-at-tpmIdLabel"),
    "2.23.133.2.16": ("TPM Specification", "tcg-at-tpmSpecification"),
    "2.23.133.2.17": ("TPM Platform Specification", "tcg-at-tcgPlatformSpecification"),
    "2.23.133.2.18": ("TPM Security Assertions", "tcg-at-tpmSecurityAssertions"),
    "2.23.133.2.19": ("TBB Security Assertions", "tcg-at-tbbSecurityAssertions"),
    "2.23.133.2.23": (
        "TCG Credential Specification",
        "tcg-at-tcgCredentialSpecification",
    ),
    "2.23.133.2.25": ("TCG Credential Type", "tcg-at-tcgCredentialType"),
    "2.23.133.2.26": (
        "TCG Previous Platform Certificates",
        "tcg-at-previousPlatformCertificates",
    ),
    "2.23.133.2.27": (
        "TCG TBB Security Assertions V3",
        "tcg-at-tbbSecurityAssertions-v3",
    ),
    "2.23.133.2.28": ("TCG Cryptographic Anchors", "tcg-at-cryptographicAnchors"),
    "2.23.133.3": ("Trusted Computing Group Protocols", "tcg-protocol"),
    "2.23.133.3.1": ("TCG TPM Protocol", "tcg-prt-tpmIdProtocol"),
    "2.23.133.4": ("Trusted Computing Group Algorithms", "tcg-algorithm"),
    "2.23.133.4.1": ("TCG NULL Algorithm", "tcg-algorithm-null"),
    "2.23.133.5": ("Trusted Computing Group Platform Classes", "tcg-platformClass"),
    "2.23.133.5.1": ("Trusted Computing Group Common", "tcg-common"),
    "2.23.133.5.1.1": (
        "TCG Platform Manufacturer String",
        "tcg-at-platformManufacturerStr",
    ),
    "2.23.133.5.1.2": ("TCG Platform Manufacturer ID", "tcg-at-platformManufacturerId"),
    "2.23.133.5.1.3": ("TCG Platform Configuration URI", "tcg-at-platformConfigUri"),
    "2.23.133.5.1.4": ("TCG Platform Model", "tcg-at-platformModel"),
    "2.23.133.5.1.5": ("TCG Platform Version", "tcg-at-platformVersion"),
    "2.23.133.5.1.6": ("TCG Platform Serial Number", "tcg-at-platformSerial"),
    "2.23.133.5.1.7": ("TCG Platform Configuration", "tcg-at-platformConfiguration"),
    "2.23.133.5.1.7.1": (
        "Platform Configuration Version 1",
        "tcg-at-platformConfiguration-v1",
    ),
    "2.23.133.5.1.7.2": (
        "Platform Configuration Version 2",
        "tcg-at-platformConfiguration-v2",
    ),
    "2.23.133.5.1.7.3": (
        "Platform Configuration Version 3",
        "tcg-at-platformConfiguration-v3",
    ),
    "2.23.133.5.1.7.4": (
        "Platform Configuration URI Version 3",
        "tcg-at-platformConfigUri-v3",
    ),
    "2.23.133.5.1.8": ("TCG Platform Identifier", "tcg-at-platformIdentifier"),
    "2.23.133.6": ("Trusted Computing Group Certificate Extensions", "tcg-ce"),
    "2.23.133.6.2": ("Relevant Credentials", "tcg-ce-relevantCredentials"),
    "2.23.133.6.3": ("Relevant Manifests", "tcg-ce-relevantManifests"),
    "2.23.133.6.4": (
        "Virtual Platform Attestation Service",
        "tcg-ce-virtualPlatformAttestationService",
    ),
    "2.23.133.6.5": (
        "Migration Controller Attestation Service",
        "tcg-ce-migrationControllerAttestationService",
    ),
    "2.23.133.6.6": (
        "Migration Controller Registration Service",
        "tcg-ce-migrationControllerRegistrationService",
    ),
    "2.23.133.6.7": (
        "Virtual Platform Backup Service",
        "tcg-ce-virtualPlatformBackupService",
    ),
    "2.23.133.8": ("Trusted Computing Group Key Purposes", "tcg-kp"),
    "2.23.133.8.1": ("Endorsement Key Certificate", "tcg-kp-EKCertificate"),
    "2.23.133.8.2": (
        "Platform Attribute Certificate",
        "tcg-kp-PlatformAttributeCertificate",
    ),
    "2.23.133.8.3": ("Attestation Identity Key Certificate", "tcg-kp-AIKCertificate"),
    "2.23.133.8.4": ("Platform Key Certificate", "tcg-kp-PlatformKeyCertificate"),
    "2.23.133.8.5": (
        "Delta Platform Attribute Certificate",
        "tcg-kp-DeltaPlatformAttributeCertificate",
    ),
    "2.23.133.8.6": (
        "Delta Platform Key Certificate",
        "tcg-kp-DeltaPlatformKeyCertificate",
    ),
    "2.23.133.8.7": (
        "Additional Platform Attribute Certificate",
        "tcg-kp-AdditionalPlatformAttributeCertificate",
    ),
    "2.23.133.8.8": (
        "Additional Platform Key Certificate",
        "tcg-kp-AdditionalPlatformKeyCertificate",
    ),
    "2.23.133.11": ("Trusted Computing Group Certificate Policies", "tcg-ca"),
    "2.23.133.11.4": (
        "TCG Verified Platform Certificate CA Policy",
        "tcg-cap-verifiedPlatformCertificate",
    ),
    "2.23.133.17": ("Trusted Computing Group Address Formats", "tcg-address"),
    "2.23.133.17.1": ("Ethernet MAC Address", "tcg-address-ethernetmac"),
    "2.23.133.17.2": ("WLAN MAC Address", "tcg-address-wlanmac"),
    "2.23.133.17.3": ("Bluetooth MAC Address", "tcg-address-bluetoothmac"),
    "2.23.133.18": ("Trusted Computing Group Registry", "tcg-registry"),
    "2.23.133.18.3": ("TCG Component Class", "tcg-registry-componentClass"),
    "2.23.133.18.3.1": (
        "Trusted Computed Group Registry",
        "tcg-registry-componentClass-tcg",
    ),
    "2.23.133.18.3.2": (
        "Internet Engineering Task Force Registry",
    ...
    "2.23.133.18.3.4": ("PCIE Component Class", "tcg-registry-componentClass-pcie"),
    "2.23.133.18.3.5": ("Disk Component Class", "tcg-registry-componentClass-disk"),
    "2.23.133.19": ("Trusted Computing Group Traits", "tcg-traits"),
    "2.23.133.19.1": ("TCG Trait Identifiers", "tcg-tr-ID"),
    "2.23.133.19.1.1": ("Boolean Trait", "tcg-tr-ID-Boolean"),
    "2.23.133.19.1.2": (
        "Certificate Identifier Trait",
        "tcg-tr-ID-CertificateIdentifier",
    ),
    "2.23.133.19.1.3": ("Common Criteria Trait", "tcg-tr-ID-CommonCriteria"),
    "2.23.133.19.1.4": ("Component Class Trait", "tcg-tr-ID-componentClass"),
    "2.23.133.19.1.5": (
        "Component Identifier V1.1 Trait",
        "tcg-tr-ID-componentIdentifierV11",
    ),
    "2.23.133.19.1.6": ("FIPS Level Trait", "tcg-tr-ID-FIPSLevel"),
    "2.23.133.19.1.7": ("ISO 9000 Level Trait", "tcg-tr-ID-ISO9000Level"),
    "2.23.133.19.1.8": ("Network MAC Trait", "tcg-tr-ID-networkMAC"),
    "2.23.133.19.1.9": ("Object Identifier Trait", "tcg-tr-ID-OID"),
    "2.23.133.19.1.10": ("Private Enterprise Number Trait", "tcg-tr-ID-PEN"),
    "2.23.133.19.1.11": (
        "Platform Firmware Capabilities Trait",
        "tcg-tr-ID-platformFirmwareCapabilities",
    ),
    "2.23.133.19.1.12": (
    ...
    "2.23.133.19.1.13": (
        "Platform Firmware Update Compliance Trait",
        "tcg-tr-ID-platformFirmwareUpdateCompliance",
    ),
    "2.23.133.19.1.14": (
        "Platform Hardware Capabilities Trait",
        "tcg-tr-ID-platformHardwareCapabilities",
    ),
    "2.23.133.19.1.15": ("Root of Trust for Measurement Trait", "tcg-tr-ID-RTM"),
    "2.23.133.19.1.16": ("Attribute Status Trait", "tcg-tr-ID-status"),
    "2.23.133.19.1.17": ("Uniform Resource Identifier Trait", "tcg-tr-ID-URI"),
    "2.23.133.19.1.18": ("UTF8String Trait", "tcg-tr-ID-UTF8String"),
    "2.23.133.19.1.19": ("IA5String Trait", "tcg-tr-ID-IA5String"),
    "2.23.133.19.1.20": (
        "PEM-Encoded Certificate String Trait",
        "tcg-tr-ID-PEMCertString",
    ),
    "2.23.133.19.1.21": ("Public Key Trait", "tcg-tr-ID-PublicKey"),
    "2.23.133.19.2": ("TCG Trait Categories", "tcg-tr-category"),
    "2.23.133.19.2.1": (
        "Platform Manufacturer Trait Category",
        "tcg-tr-cat-platformManufacturer",
    ),
    "2.23.133.19.2.2": ("Platform Model Trait Category", "tcg-tr-cat-platformModel"),
    "2.23.133.19.2.3": (
        "Platform Version Trait Category",
        "tcg-tr-cat-platformVersion",
    ),
    "2.23.133.19.2.4": ("Platform Serial Trait Category", "tcg-tr-cat-platformSerial"),
    "2.23.133.19.2.5": (
        "Platform Manufacturer Identifier Trait Category",
        "tcg-tr-cat-platformManufacturerIdentifier",
    ),
    "2.23.133.19.2.6": (
        "Platform Ownership Trait Category",
        "tcg-tr-cat-platformOwnership",
    ),
    "2.23.133.19.2.7": ("Component Class Trait Category", "tcg-tr-cat-componentClass"),
    "2.23.133.19.2.8": (
        "Component Manufacturer Trait Category",
        "tcg-tr-cat-componentManufacturer",
    ),
    "2.23.133.19.2.9": ("Component Model Trait Category", "tcg-tr-cat-componentModel"),
    "2.23.133.19.2.10": (
        "Component Serial Trait Category",
        "tcg-tr-cat-componentSerial",
    ),
    "2.23.133.19.2.11": (
        "Component Status Trait Category",
        "tcg-tr-cat-componentStatus",
    ),
    "2.23.133.19.2.12": (
        "Component Location Trait Category",
        "tcg-tr-cat-componentLocation",
    ),
    "2.23.133.19.2.13": (
        "Component Revision Trait Category",
        "tcg-tr-cat-componentRevision",
    ),
    "2.23.133.19.2.14": (
        "Component Field Replaceable Trait Category",
        "tcg-tr-cat-componentFieldReplaceable",
    ),
    "2.23.133.19.2.15": ("EK Certificate Trait Category", "tcg-tr-cat-EKCertificate"),
    "2.23.133.19.2.16": ("IAK Certificate Trait Category", "tcg-tr-cat-IAKCertificate"),
    "2.23.133.19.2.17": (
        "IDevID Certificate Trait Category",
        "tcg-tr-cat-IDevIDCertificate",
    ),
    "2.23.133.19.2.18": (
        "DICE Certificate Trait Category",
        "tcg-tr-cat-DICECertificate",
    ),
    "2.23.133.19.2.19": (
        "SPDM Certificate Trait Category",
        "tcg-tr-cat-SPDMCertificate",
    ),
    "2.23.133.19.2.20": ("PEM Certificate Trait Category", "tcg-tr-cat-PEMCertificate"),
    "2.23.133.19.2.21": (
        "Platform Certificate Trait Category",
        "tcg-tr-cat-PlatformCertificate",
    ),
    "2.23.133.19.2.22": (
        "Delta Platform Certificate Trait Category",
        "tcg-tr-cat-DeltaPlatformCertificate",
    ),
    "2.23.133.19.2.23": (
        "Rebase Platform Certificate Trait Category",
        "tcg-tr-cat-RebasePlatformCertificate",
    ),
    "2.23.133.19.2.24": (
        "Generic Certificate Trait Category",
        "tcg-tr-cat-genericCertificate",
    ),
    "2.23.133.19.2.25": ("Common Criteria Trait Category", "tcg-tr-cat-CommonCriteria"),
    "2.23.133.19.2.26": (
        "Component Identifier V1.1 Trait Category",
        "tcg-tr-cat-componentIdentifierV11",
    ),
    "2.23.133.19.2.27": ("FIPS Level Trait Category", "tcg-tr-cat-FIPSLevel"),
    "2.23.133.19.2.28": ("ISO 9000 Trait Category", "tcg-tr-cat-ISO9000"),
    "2.23.133.19.2.29": ("Network MAC Trait Category", "tcg-tr-cat-networkMAC"),
    "2.23.133.19.2.30": (
        "Attestation Protocol Trait Category",
        "tcg-tr-cat-attestationProtocol",
    ),
    "2.23.133.19.2.31": ("Private Enterprise Number Trait Category", "tcg-tr-cat-PEN"),
    "2.23.133.19.2.32": (
        "Platform Firmware Capabilities Trait Category",
        "tcg-tr-cat-platformFirmwareCapabilities",
    ),
    "2.23.133.19.2.33": (
        "Platform Hardware Capabilities Trait Category",
        "tcg-tr-cat-platformHardwareCapabilities",
    ),
    "2.23.133.19.2.34": (
    ...
    "2.23.133.19.2.35": (
        "Platform Firmware Update Compliance Trait Category",
        "tcg-tr-cat-platformFirmwareUpdateCompliance",
    ),
    "2.23.133.19.2.36": (
        "Root of Trust of Measurement Trait Category",
        "tcg-tr-cat-RTM",
    ),
    "2.23.133.19.2.37": ("Public Key Trait Category", "tcg-tr-cat-PublicKey"),
    "2.23.133.19.3": ("TCG Trait Registries", "tcg-tr-registry"),
}
